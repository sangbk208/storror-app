...
function HeaderListContact(props) {
    return (
        <div>
            ...
            <label for="nav-mb-input" className="header__navbar-btn">
            ...
            <label for="nav-mb-input" className="header__navbar-overlay"></label>
            {/* Nav mobibe */}
            <nav className="header__navbar-mb">
                <label for="nav-mb-input">
                    <i class="header__navbar-mb-icon-time fas fa-times"></i>
                </label>
                ...
                <ul className="header__navbar-mb-list">
                    ...
                    <li className="header__navbar-mb-item">
                        ...
                        <label for="nav-mb-input-store">
                                <i className="header__navbar-mb-icon fas fa-chevron-down"></i>
                        </label>
